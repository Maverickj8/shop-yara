...
const slides = [
  {
    ...
    subtext:
      "Discover our exquisite collection of premium perfumes and handcrafted jewelry, curated for the discerning taste.",
  ...
  },
  {
    ...
    subtext:
      "Experience the art of luxury perfumery with our signature fragrances, each crafted to perfection.",
    overlay: "bg--200/30",
  },
  {
    id: 3,
    ...
    subtext:
      "Adorn yourself with our stunning collection of jewelry, presented in luxurious velvet boxes.",
    overlay: "bg-pink-200/30",
  },
];
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div
            ...
            style={{ 
  backgroundImage: `linear-gradient(to bottom, rgba(180, 50, 90, 0.55), rgba(120, 20, 60, 0.75)), url(${slides[currentSlide].image})`,
