          ...
          <div className="md:col-span-2">
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-gold"
              />
              <button
                type="submit"
                className="px-6 py-2 bg-gold text-gray-900 rounded-lg font-semibold hover:bg-gold/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">
              © 2026 Shop Yara. All Rights Reserved.
            </p>
